...
```{r Do mean blood test results change from pre to post, fig.height=4,fig.width=13 , message = F}
...
plot_grid(Chole, Trigs , HDL, LDL, nonHDL.Chol, Glu, Ins, Homa.IR, nrow = 2)
