...
```{r, plot, echo = F, fig.height = 6, fig.width = 11}
...
ggplot(map, aes(x = StudyDayNo, y = Subject)) +
  geom_point(pch = 21, size = 3.5, col = "white") + 
  ...
  geom_point(aes(fill = as.factor(map$plot_fill)), pch = 21, size = 3.5) +
  scale_fill_manual("Data Availability", values = cols) +
  theme_classic() +
